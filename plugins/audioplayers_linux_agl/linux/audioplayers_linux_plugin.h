...
public:
  ...
  void Dispose(
      ...
      std::function<void(std::optional<FlutterError> reply)> result) override;
  void
  GetCurrentPosition(const std::string &player_id,
  ...
  void GetDuration(const std::string &player_id,
                   std::function<void(ErrorOr<std::optional<int64_t>> reply)>
                       result) override;
  void
  Pause(const std::string &player_id,
        std::function<void(std::optional<FlutterError> reply)> result) override;
  void Release(
      const std::string &player_id,
      std::function<void(std::optional<FlutterError> reply)> result) override;
  void Resume(
      ...
      std::function<void(std::optional<FlutterError> reply)> result) override;
  void
  Seek(const std::string &player_id, int64_t position,
       std::function<void(std::optional<FlutterError> reply)> result) override;
  void SetBalance(
  ...
  void SetVolume(
      ...
      std::function<void(std::optional<FlutterError> reply)> result) override;
  void
  Stop(const std::string &player_id,
       std::function<void(std::optional<FlutterError> reply)> result) override;
  void EmitLog(
